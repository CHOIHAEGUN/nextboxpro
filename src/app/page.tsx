    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:size-auto lg:bg-none">
          ...
          <Image
            src={`https://commerce.ibkbox.net/api/mk/v1/file/render/image/773bcbdb-1ebc-47e2-ae1c-0d48e45c9c8d`}
            alt="Vercel Logo"
          ...
          />
          <Image
            src={`https://commerce.ibkbox.net/api/mk/v1/file/render/image/4e9c3c13-c1a0-485a-8d21-9329fe54dc72`}
            alt="Vercel Logo"
            className="dark:invert"
            width={100}
            height={24}
          ...
          />
          <Image
            src={`https://commerce.ibkbox.net/api/mk/v1/file/render/image/cbfb1d5b-2081-495a-99a5-a25832ccf467`}
            alt="Vercel Logo"
            className="dark:invert"
            width={100}
            height={24}
